...
モデリングに関する内容で、[astah* community](http://astah.change-vision.com/ja/product/astah-community.html)も併用したセッションが行われる予定です。
...
さらに詳しいプロフィールにつきましては、[こちら](https://anagileway.wordpress.com/about/)をご参照ください。

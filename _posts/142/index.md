...
{% include event_links.html is_event_open_or_closed="closed" doorkeeper_url="https://kzrb.doorkeeper.jp/events/174244" %}
...
* Zoom と同時にテキストチャットルームも活用します。
    ...
    * Slack というサービスの [Kanazawa.rb 用ワークスペース内](https://kzrb.slack.com/) にある `#meetup142` チャネルにご参加ください。
...
| LT 「さようならWindows」 | 15:00 | 5m | kanontonto1010 |
| LT 「仮想アドレスから物理アドレスへの変換方法」 | 15:05 | 5m | satoru.takeuchi |
| LT 「「俺とコミュニティ」をイベントで話した」 | 15:10 | 5m | pharaohkj |
| 運営ブレスト                      | 16:10 | 30m  | 有志                                                    |

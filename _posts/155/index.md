...
{% include event_links.html is_event_open_or_closed="closed" doorkeeper_url="https://kzrb.doorkeeper.jp/events/186278" %}
...
* Zoom と同時にテキストチャットルームも活用します。
    ...
    * Slack というサービスの [Kanazawa.rb 用ワークスペース内](https://kzrb.slack.com/) にある `#meetup155` チャネルにご参加ください。
...
| LT 発表                           | 15:30 |      |                                                         |
| 「YouTuberとして食っていきたい」  | | 5m | @sat |
| 「俺とAWS SUMMIT JAPAN 2025　ー生成エイアイはイケてそうかー」  | | 5m | @PharaohKJ |
| 運営ブレスト                      | 16:10 | 30m  | 有志                                                    |

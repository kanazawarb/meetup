...
{% include event_links.html is_event_open_or_closed="open" doorkeeper_url="https://kzrb.doorkeeper.jp/events/199558" %}
...
* Zoom と同時にテキストチャットルームも活用します。
    ...
    * Slack というサービスの [Kanazawa.rb 用ワークスペース内](https://kzrb.slack.com/) にある `#meetup170` チャネルにご参加ください。

...
{% include event_links.html is_event_open_or_closed="closed" doorkeeper_url="https://kzrb.doorkeeper.jp/events/176382" %}

# Meetup #144

## 内容「祝12周年 LT大会」 (オフライン開催)

なんでもいいので話しちゃいなよ！！ 参加者全員が「どんな内容でも良いので」参加者に向けて発表することを目標にしています。
感染症対策を十分におこなった上で、対面イベントとして実施いたします。

Kanazawa.rb はおかげさまで12周年を迎えます。地域のエンジニアが情報交換をする場として、こつこつと続けてきました。肩肘を張らない、緩く心地よい場所としてこれからも活動を続けていきます。

12周年のノベルティグッズとして、ミニタオルをご用意しています。

<div style="text-align:center">
<img src="towel.jpg" style="width: 320px">
</div>
...
* テキストチャットルームも活用します。
    ...
    * Slack というサービスの [Kanazawa.rb 用ワークスペース内](https://kzrb.slack.com/) にある `#meetup144` チャネルにご参加ください。
...
**Meetup #144では、全員が LT でなにか発表することを目標にしています！どんな内容でもよいので、是非なにかひとつテーマを持って来てください。**

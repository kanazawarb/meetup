...
{% include event_links.html is_event_open_or_closed="closed" doorkeeper_url="https://kzrb.doorkeeper.jp/events/175412" %}
...
* Zoom と同時にテキストチャットルームも活用します。
    ...
    * Slack というサービスの [Kanazawa.rb 用ワークスペース内](https://kzrb.slack.com/) にある `#meetup143` チャネルにご参加ください。
